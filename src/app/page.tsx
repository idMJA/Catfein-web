    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="h-screen flex items-center justify-center container mx-auto px-4 relative overflow-hidden">
        ...
        >
          ...
          >
            The purr-fect Hosting platform. Experience lightning-fast performance with enterprise-grade reliability.
          </MotionDiv>
          <MotionDiv
            variants={fadeInUp}
      ...
      >
        ...
        >
          Unlock powerful features to enhance your bot's performance and capabilities
        </MotionDiv>
        <MotionDiv 
          variants={staggerContainer}
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-lg">Experience lightning-fast response times and seamless scaling for your growing community.</p>
          </MotionDiv>
          <MotionDiv 
            variants={fadeInUp}
            className="bg-zinc-900 p-12 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all"
          >
            ...
            <p className="text-gray-400 text-lg">Monitor your bot's performance with our intuitive dashboard.</p>
          </MotionDiv>
          <MotionDiv 
            variants={fadeInUp}
            className="bg-zinc-900 p-12 rounded-xl border border-zinc-800 hover:border-zinc-700 transition-all"
          >
            ...
            <p className="text-gray-400 text-lg">Enterprise-grade DDoS protection for maximum security.</p>
          </MotionDiv>
        </MotionDiv>
      </MotionSection>
      ...
      >
        ...
        >
          Discover what our amazing community has to say about their experience with Catfein
        </MotionDiv>
        <MotionDiv 
          variants={staggerContainer}
        ...
        >
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-800">
                <img src="/users/mj.png" alt="iaMJ" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <p className="text-gray-300 mt-4">So far so good, but mostly I'm a skill issue</p>
          </MotionDiv>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-800">
                <img src="/users/ducky.gif" alt="avatar" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <p className="text-gray-300 mt-4">The new website IS SOO MUCH BETTER. But like make the navigation easier Home, Servers, Store, News</p>
          </MotionDiv>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-800">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=emma" alt="avatar" className="w-full h-full object-cover" />
              </div>
              <div>
                <h4 className="font-semibold text-gray-200">EmmaScript</h4>
                <p className="text-gray-500">@emmacodes</p>
              </div>
            </div>
            <p className="text-gray-300 mt-4">Security is so tight, my bot rejected its own commands for being suspicious. Better safe than sorry!</p>
          </MotionDiv>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-800">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=mike" alt="avatar" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <p className="text-gray-300 mt-4">The scaling is amazing! My bot handled so many users, it started a support group for overworked Discord bots.</p>
          </MotionDiv>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="h-12 w-12 rounded-full overflow-hidden bg-zinc-800">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=lily" alt="avatar" className="w-full h-full object-cover" />
              </div>
              <div>
            ...
            <p className="text-gray-300 mt-4">Dashboard is so intuitive, my cat walked across the keyboard and accidentally optimized my bot's performance!</p>
          </MotionDiv>
        </MotionDiv>
      </MotionSection>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-xl font-semibold text-gray-300">AIO (Bash)</span>
          </MotionDiv>
          <MotionDiv 
            variants={fadeInUp}
            whileHover={{ 
        ...
        <div className="mt-12 text-center">
          ...
          <a href="#" className="inline-block mt-4 bg-zinc-800 text-gray-300 hover:bg-zinc-700 px-6 py-3 rounded-lg text-base font-medium transition-colors">
            Join Discord Server
          </a>
        </div>
      </MotionSection>
      ...
      >
        ...
        >
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-400">
            Join thousands of developers who trust Catfein for their Discord bot hosting needs
          </p>
