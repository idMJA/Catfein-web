			...
			<main className="pt-24">
				...
				<section className="container mx-auto px-8 py-24 text-center">
					...
					<p className="text-xl text-gray-400 max-w-3xl mx-auto">
						We&apos;re a passionate team dedicated to revolutionizing hosting
						solutions and providing the best experience for developers.
					</p>
				</section>
					...
					<div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
						{teamMembers.map((member) => (
							<div
								...
								className="bg-zinc-900/50 rounded-xl p-8 border border-zinc-800/50"
							>
